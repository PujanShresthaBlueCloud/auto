...
export default function Navbar() {
  ...
  return (
    <div className="w-full fixed top-0 bg-white dark:bg-gray-900 z-50 shadow-sm">
            ...
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                <Link href="#hero" scroll={false}>
                  <span className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100 cursor-pointer">
                    {/* <img
                      src="/img/logo.svg"
                      alt="Logo"
                      width="32"
